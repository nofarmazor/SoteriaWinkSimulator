...
class Wink(object):
    ...
    #Soteria: change device state
    def update_device_state(self, device_type, device_id, data):
        return self._put("/" + str(device_type) + "/" + str(device_id), data)
    ...
    #Soteria: Add get device by id method:
    def get_device_by_id(self, device_type, device_id):
        return self._get("/" + str(device_type) + "/" + str(device_id))
